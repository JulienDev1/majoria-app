          ...
          <div className="space-y-5 text-slate-200 text-xs sm:text-sm leading-relaxed">
            ...
            <div className="p-4 rounded-xl bg-white/[0.03] border-[0.5px] border-white/10 space-y-2">
              ...
              <ul className="space-y-1.5 text-slate-300">
                ...
                <li><strong>Responsable de publication :</strong> Major2IA (Contact : <span className="font-mono text-sky-300">major.int.art@gmail.com</span>)</li>
                <li><strong>Statut :</strong> Édition de service numérique & applicatif web interactif</li>
                <li><strong>Contact Support :</strong> <span className="font-mono text-sky-300">major.int.art@gmail.com</span></li>
              </ul>
            </div>
            ...
            <div className="p-4 rounded-xl bg-white/[0.03] border-[0.5px] border-white/10 space-y-2">
              ...
              <ul className="space-y-1 text-slate-300 list-disc list-inside">
                ...
                <li>Pour toute demande relative aux données personnelles : contactez <span className="font-mono text-sky-300">major.int.art@gmail.com</span>.</li>
              </ul>
            </div>
