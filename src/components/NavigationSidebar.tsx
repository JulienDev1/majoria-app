...
export const NavigationSidebar: React.FC<NavigationSidebarProps> = ({
  ...
  const categories = [
    { id: 'tous', label: 'Tous', color: 'bg-white/10 text-white border-white/20' },
    { id: 'favoris', label: '⭐ Favoris', color: 'bg-amber-500/20 text-amber-200 border-amber-400/30' },
    { id: 'général', label: 'Général', color: 'bg-purple-500/20 text-purple-200 border-purple-400/30' },
    { id: 'travail', label: 'Travail', color: 'bg-sky-500/20 text-sky-200 border-sky-400/30' },
    { id: 'perso', label: 'Perso', color: 'bg-emerald-500/20 text-emerald-200 border-emerald-400/30' },
                      ...
                      <div className="flex items-center justify-between gap-1.5">
                        ...
                        <div className="opacity-0 group-hover:opacity-100 flex items-center gap-1 transition-opacity shrink-0">
                          <button
                            ...
                            title={conv.favori ? "Retirer des favoris" : "Ajouter aux favoris"}
          ...
          <div className="flex items-center justify-between gap-2 p-2.5 rounded-xl bg-white/[0.04] border-[0.5px] border-white/15 backdrop-blur-xl">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-xs font-extrabold font-mono text-white flex items-center gap-1">
                  ...
                  <span className="text-[10px] font-normal text-slate-400 font-sans">restant</span>
                </div>
              </div>
            </div>
            ...
            {onOpenForfaits && (
              <button
                ...
                title="Consulter les forfaits et le report mensuel"
              >
