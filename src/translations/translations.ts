...
export const translations: Record<Language, TranslationsSchema> = {
  fr: {
    ...
    chat: {
      ...
      welcomeTitle: 'Major2I.A // Matrice Cognitive',
      welcomeDesc: 'Je suis Major2I.A, votre assistant intelligent. Posez-moi une question, dictez vocalement ou téléversez un document.',
      ...
      placeholder: 'Écrire à Major2I.A...',
      inputPlaceholder: 'Écrire à Major2I.A...',
      ...
      aiThinking: 'Major2I.A réfléchit et synthétise...',
      model: 'Modèle Neural Major2I.A Pro',
      ...
      batteryExhausted: 'IA déchargée (0% restant). Rechargez pour débloquer l’envoi.',
      recharge: 'Recharger',
      mic: 'Micro',
    ...
    transcription: {
      ...
      summarize: 'Synthétiser avec Major2I.A',
    ...
    memoire: {
      title: 'Mémoire & Notes',
      subtitle: 'Données contextuelles retenues par Major2I.A pour personnaliser ses réponses.',
      ...
      addSuccess: 'Information mémorisée par Major2I.A.',
    ...
    settings: {
      ...
      languageDescription: 'Choisissez la langue principale de l’interface Major2I.A (Français ou Anglais).',
      ...
      identityDesc: 'Major2I.A s’adressera à vous personnellement',
  ...
  en: {
    ...
    chat: {
      welcome: 'Welcome',
      welcomeTitle: 'Major2I.A // Cognitive Matrix',
      welcomeDesc: 'I am Major2I.A, your intelligent assistant. Ask me questions, dictate by voice, or upload files.',
      ...
      placeholder: 'Write to Major2I.A...',
      inputPlaceholder: 'Write to Major2I.A...',
      ...
      aiThinking: 'Major2I.A is processing and thinking...',
      model: 'Major2I.A Pro Neural Model',
    ...
    transcription: {
      ...
      summarize: 'Summarize with Major2I.A',
    ...
    memoire: {
      title: 'Memory & Notes',
      subtitle: 'Contextual facts remembered by Major2I.A to personalize future answers.',
    ...
    settings: {
      ...
      languageDescription: 'Choose the main language of Major2I.A interface (French or English).',
      languageFr: 'Français (FR)',
      languageEn: 'English (EN)',
      ...
      identityDesc: 'Major2I.A will address you personally',
      preview: 'Preview',
